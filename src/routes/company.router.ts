...
import { validarBusinessUnit, idParamRequired } from "@validators/company.validator";
...
router.get("/company/:id", idParamRequired, validate, requierePermiso('BUS_UNIT_VIEW', 'READ'), company.getOneBusinessController);
router.get("/companys", requierePermiso('BUS_UNIT_VIEW', 'READ'), company.listBusinessController);
router.post("/company", validarBusinessUnit, validate, requierePermiso('BUS_UNIT_CREATE', 'CREATE'), company.createBuController);
router.put("/company/:id", idParamRequired, validate, requierePermiso('BUS_UNIT_UPDATE', 'UPDATE'), company.aptBuController);
...
router.put("/company/file/:id", idParamRequired, validate, upload.single('file'), requierePermiso('BUS_UNIT_UPDATE', 'UPDATE'), company.putImageBuController);
